...
class HardBinaryConv(nn.Conv2d):
    ...
    def weight_binarizer(self, real_weights):
    ...
    def input_binarizer(self, x):
        return x


    def forward(self, x):
        real_weights = self.weight
        binary_weights = self.weight_binarizer(real_weights)
...
class BinaryConv2d(nn.Module):
    ...
    @property
    def weight(self):
        return self.binary_conv.weight

    @property
    def groups(self):
        return self.binary_conv.groups

    @property
    def weight_binarizer(self):
        return self.binary_conv.weight_binarizer

    @property
    def bias(self):
        return self.binary_conv.bias

    @property
    def stride(self):
        return self.binary_conv.stride

    @property
    def padding(self):
        return self.binary_conv.padding

    @property
    def dilation(self):
        return self.binary_conv.dilation
